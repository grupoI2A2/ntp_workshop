...
- The Virtual Noise Audit Coordinator (VNAC) will provide each participant the set of measurements they request according to their requirements. The measurement locations, duration, and setup will be specified in the pdf form you can download in [this link] (https://github.com/grupoI2A2/ntp_workshop/raw/master/web/images/Measurement%20request%20form%20-%20Virtual%20Noise%20Audit.pdf).Once you have filled out the form, you must send it to [erasmusplusnoise@gmail.com](mailto:erasmusplusnoise@gmail.com) and the requested data will be sent to you as soon as possible.
